...
- [pgbackweb](https://github.com/eduardolat/pgbackweb) `🐘 Effortless PostgreSQL backups with a 
...
- [rustgrab](https://github.com/ktwrd/rustgrab) `ShareX-like screenshot utility for Linux`
- [Ulauncher](https://ulauncher.io/) `Application Launcher. Alternative to Flow Launcher/PowerToys Run.`
